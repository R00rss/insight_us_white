        ...
        getInicialDataEncuesta().then((response) => {
            ...
            if ("success" in response && response.success) {
                const options_filter_bar_temp = {
                    ...
                    //         },
                    //         {
                    //             display_name: 'destrezas de servicios',
                    //             name: 'destrezas de servicios',
                    //             value: false
                    //         },
                    //         {
                          ...
                          10
                                    ...
                                    >
                                        ...
                                        {option_filter_bar_key === "subindicador" ? (<>
                                            {options_filter_bar[option_filter_bar_key].options['experiencia'].map((option, j) => (
                                                <li
                                                    key={j}
                                                    className="capitalize bg-[#0cd4d4bb] rounded-md px-1 hover:bg-[#0cd4d477]"
                                                ...
                                                >
                                                    <div
                                                        ...
                                                        <div>
                                                            {minimizeStr(option.display_name.toLowerCase(), 18)}
                                                        </div>
